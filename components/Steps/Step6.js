...
export default function Step6() {
  ...
  return (
    <div
      ...
      <div className="flex lg:flex-nowrap md:flex-wrap md:flex-row flex-col lg:items-start md:items-start relative lg:justify-between md:justify-start lg:mt-16 md:mt-10 mt-6 md:space-y-0 space-y-4">
      ...
      <div className="relative md:hidden flex flex-col items-center mt-10">
        <div className="flex">
        ...
        <div className="text-center font-visby mt-3">
          <p className="text-lg font-bold my-2">Gut für die Umwelt</p>
